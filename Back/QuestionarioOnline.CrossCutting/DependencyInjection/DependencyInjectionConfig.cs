...
public static class DependencyInjectionConfig
{
    ...
    {
        var databaseName = configuration["MongoDB:DatabaseName"] ?? "QuestionarioOnlineDb";

        services.AddSingleton<MongoDbContext>(_ => new MongoDbContext(connectionString, databaseName));
