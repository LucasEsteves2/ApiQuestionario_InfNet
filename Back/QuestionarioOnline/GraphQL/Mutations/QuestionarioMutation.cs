...
namespace QuestionarioOnline.Api.GraphQL.Mutations
{
    public class QuestionarioMutation : ObjectGraphType
    {
        ...
        private static async Task<Guid> ObterUsuarioMock(MongoDbContext dbContext)
        {
            var usuario = await dbContext.Usuarios.Find(_ => true).FirstOrDefaultAsync();
            ...
            if (usuario == null)
            {
                ...
                await dbContext.Usuarios.InsertOneAsync(usuario);
            }
